...
class ActivationWatcher:
    ...
    def _get_layers(self):
        ...
        # remove BN layers
        layers = [layer for layer in layers if not isinstance(attrgetter(layer)(self.model), FrozenBatchNorm2d)]
    ...
    def _get_bn_layers(self):
        ...
        # only keep BN layers
        layers = [layer for layer in layers if isinstance(attrgetter(layer)(self.model), FrozenBatchNorm2d)]
